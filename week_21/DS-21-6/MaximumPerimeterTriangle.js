...
// triange with the maximum possible perimeter. Print the lengths of its sides 
// as  space-separated integers in non-decreasing order.
...
// For example, assume there are stick lengths . The triplet  will not form a triangle. 
// Neither will  or , so the problem is reduced to  and . The longer perimeter is .

// Function Description

// Complete the maximumPerimeterTriangle function in the editor below. It should return an 
// array of  integers that represent the side lengths of the chosen triangle in non-decreasing
//  order.
...
// The second triangle has the largest perimeter, so we print its side lengths on a new
//  line in non-decreasing order.
