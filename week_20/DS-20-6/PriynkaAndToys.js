...
//  to the determine the lowest cost way to combine her orders for shipping. She has a
//  list of item weights. The shipping company has a requirement that all items loaded 
// in a container must weigh less than or equal to 4 units plus the weight of the minimum
...
// For example, there are items with weights . This can be broken into two containers:  
// and . Each container will contain items weighing within  units of the minimum weight item.

// Function Description

// Complete the toys function in the editor below. It should return the minimum number 
// of containers required to ship.
