...
//  For example, the diagram below depicts the three possible ways to cut a  piece of paper:
// example-cutting-squares.png
// Given  and , find and print the minimum number of cuts Mary must make to cut the paper
//  into  squares that are  unit in size.
...
function solve(n, m) {
  return BigInt(n) * BigInt(m) - BigInt(1);
}
